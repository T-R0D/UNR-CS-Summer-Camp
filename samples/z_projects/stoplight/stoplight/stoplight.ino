 ...
 *   1. Add a borken state/maintenance cycle, where all red lights blink
 *      simultaneously and drivers treat the light as a stop sign.
 *   2. Allow opposing directions to have simultaneous green lights.
 *   3. Add interruptibility using sensors so lanes don't wait for the
 *      full cycle.
 *   4. Add left turn lights.
 *   5. Improve the code to be even more general using language features
